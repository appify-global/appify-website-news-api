...
2. **Output Format - CRITICAL**:
   ...
   - End directly with the content - no conclusion statements

3. **Evergreen Theme Extraction**: 
...
4. **Target Search Intent**: Focus on stable, long-term search intent within:
   - App development
   - AI integration
...
10. **Company Mentions**: If companies are mentioned in the RSS article:
...
Generate the article now. Output ONLY the article content in markdown format - no explanations, no introductions, no conclusions. Start directly with the content.`,
      },
    ],
  });
